  ...
  const footerSections = [
    {
      ...
      links: [
        ...
        { name: 'API Integration', href: '/templates' },
          ...
          <div className="lg:col-span-2 space-y-6">
            <div>
              ...
              <p className="text-muted-foreground text-sm leading-relaxed mb-6">
                Streamline your business operations with our comprehensive SaaS platform. Trusted by
                over 50,000 companies worldwide to automate workflows and boost productivity.
              </p>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-3 text-sm">
                ...
                <span className="text-muted-foreground">+1 (888) 247-3892</span>
              </div>
              <div className="flex items-center gap-3 text-sm">
                <MapPin className="size-4 text-primary flex-shrink-0" />
                <span className="text-muted-foreground">
                  2847 Innovation Drive, San Francisco, CA
                </span>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-2 text-sm text-muted-foreground">
              <span>© 2024 CloudSync Technologies. All rights reserved.</span>
