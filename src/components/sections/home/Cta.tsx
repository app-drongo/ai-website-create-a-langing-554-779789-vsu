          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                CloudFlow empowers modern SaaS companies with intelligent automation, real-time
                analytics, and seamless integrations. Join 50,000+ businesses already scaling with
                our platform.
              </p>
              ...
              <div className="text-center mb-12">
                <p className="text-sm text-muted-foreground mb-6">
                  Trusted by fast-growing SaaS companies worldwide
                </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                SOC 2 compliant with 99.9% guaranteed uptime
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Launch in under 5 minutes with one-click setup
              </p>
            </div>
          </div>
        </div>
